...
\begin{figure}[t]
  ...
  \hfill
  \subfloat[relative error with $\tau=0.3$]{\includegraphics[width=0.5\textwidth]{./figures/T=0.3,K=0.15, kappa=4,m=0.15, sigma=0.6, gamma=0.75 price.png}\label{price diff5}} \\
...
\begin{figure}[ht]
  ...
  \subfloat[price comparison with $\tau=0.5$]{\includegraphics[width=0.5\textwidth]{./figures/heston cev rho=0.5,T=0.5,K=0.15, kappa=4,kappa2 =2,theta=0.2, sigma1=0.3,sigam2=0.8, gamma=1.6 error.png}\label{heston price comparison3}}
  \hfill
...
\begin{figure}[ht]
  ...
  \subfloat[price comparison with $\tau=0.5$]{\includegraphics[width=0.5\textwidth]{./figures/heston cev rho=-0.5,T=0.5,K=0.15, kappa=4,kappa2 =2,theta=0.2, sigma1=0.3,sigam2=0.8, gamma=1.6 error.png}\label{heston price comparison6}}
  \hfill
